...
function aquaar_script_enqueue() {
    ...
    wp_enqueue_style('customstyle', get_template_directory_uri() . '/css/main.min.css', array(), '1.0.4', 'all');
    ...
    wp_enqueue_script('customjs', get_template_directory_uri() . '/js/script.min.js', array('jquery'), '1.1.7', true);
